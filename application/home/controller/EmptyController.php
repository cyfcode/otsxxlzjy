        ...
        if(DBNAME=='page'){
            ...
            if(DBNAME=='team'){
                ...
                foreach ($list['data'] as $k=>$v){
                    ...
                    $list['data'][$k]['url'] = url('home/'.$v['catdir'].'/info',array('id'=>$v['id'],'catId'=>$v['catid']));
                    $date = toDate($v['createtime'],'Y-m-d H:i:s');
                    $list['data'][$k]['createtime'] = toDate($v['createtime'],'Y-m-d H:i:s');
                    if(isset($v['thumb'])){
            ...
            $cateData = db('category')->where('id',input('catId'))->find();
            $this->assign('cateData', $cateData);
            $cattemplate = $cateData['template_list'];
