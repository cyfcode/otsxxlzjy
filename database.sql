...
INSERT INTO `clt_ad` VALUES (15,'正式开业',1,'/uploads/20180611/c09ce57b7b5264ccbefef44c2591117b.png','',1480909037,1,1,'OTS租车新西兰皇后镇营业所于2017年11月1日正式开业。\n并且在2018年5月16日又开设了基督城营业所。'),(17,'充分发挥迄今为止积累的经验',1,'/uploads/20180611/25e5f5a08933130f026a6119666b44a8.png','',1481788850,2,1,'充分发挥迄今为止积累的经验，提供与日本国内相同品质的服务，如「舒适的车室空间」「贴心的可追加选项」「万一发生意外时的充分保障」等。'),(18,'为了让您的旅途充满欢笑，OTS租车公司一直在努力!',1,'/uploads/20180611/814e5f76ef5dce49dfd3dce771631ecf.png','',1481788869,3,1,'为了让您的旅途充满欢笑，OTS租车公司一直在努力!'),(36,'顶部横幅',5,'/uploads/20180730/e3a6661e9f9a4af50c2ca6cd98d7ce2a.jpg','',1532953940,50,1,''),(37,'背景图片',10,'/uploads/20180730/ab95e6e30d9fa769514d55b1ef26af02.jpg','',1532954239,50,1,''),(38,'帖图',10,'/uploads/20180730/727fbe264b5794a614d860c49025c4bc.png','',1532954279,50,1,''),(39,'官方微信',12,'/uploads/20180731/6582cce1134420e8bdbcac271322ad21.png','',1533007943,50,1,'');
...
CREATE TABLE `clt_ad_type` (
  ...
  PRIMARY KEY (`type_id`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='广告分类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `clt_ad_type` VALUES (1,'【首页】底部轮播',1),(5,'【首页】顶部横幅',2),(10,'【首页】底部轮播背景',50),(11,'【首页】底部四图卡片',50),(12,'全局底部二维码',50);
...
INSERT INTO `clt_admin` VALUES (1,'admin','e10adc3949ba59abbe56e057f20f883e',1,'1109305987@qq.com','','18792402229','127.0.0.1',1482132862,'0',1,'/uploads/20180625/f266169c2956429d9aaea6cf6f1e51cb.jpg'),(11,'travel','e10adc3949ba59abbe56e057f20f883e',2,'18667160723@163.com',NULL,'18667160723','::1',1531747355,'0',0,'');
...
CREATE TABLE `clt_car` (
  ...
  `title` varchar(80) NOT NULL DEFAULT '' COMMENT '型号',
  ...
  `people` int(10) unsigned NOT NULL DEFAULT '1' COMMENT '限乘人数',
  `capacity` int(10) unsigned NOT NULL DEFAULT '1' COMMENT '收容目安',
  `baggage` int(11) NOT NULL DEFAULT '1' COMMENT '行李件数',
  `trunk` mediumtext NOT NULL COMMENT '后备箱尺寸',
  `quick` int(10) unsigned NOT NULL DEFAULT '1' COMMENT '快適人数',
  `gas` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排气量(cc)',
  `oil` decimal(10,1) unsigned NOT NULL DEFAULT '0.0' COMMENT '耗油量（km/L）',
  `carsize` mediumtext NOT NULL COMMENT '车身尺寸',
  `prices` text NOT NULL COMMENT '定价表',
  `album` mediumtext NOT NULL COMMENT '图片集',
  `address` mediumtext NOT NULL COMMENT '取车营业所',
...
--
-- Dumping data for table `clt_car`
--

LOCK TABLES `clt_car` WRITE;
/*!40000 ALTER TABLE `clt_car` DISABLE KEYS */;
INSERT INTO `clt_car` VALUES (1,17,1,'admin','PRIUS 4WD','color:;font-weight:normal;','/uploads/20180728/c596797a2dff61969c19381cd20e6c9e.png','','低重心车身的完美外观，加上每升油可行驶37.2km世界级低耗油性能，还搭载了可协助避免冲撞的安全防护系统。另外，在斜坡、车轮印路面、地下水井盖、停车场内等，即使在雪地也能保持平稳行驶。丰田PRIUS伴您尽情享受您的旅程！','<p><span>低重心车身的完美外观，加上每升油可行驶37.2km世界级低耗油性能，还搭载了可协助避免冲撞的安全防护系统。另外，在斜坡、车轮印路面、地下水井盖、停车场内等，即使在雪地也能保持平稳行驶。丰田PRIUS伴您尽情享受您的旅程！</span></p>','',0,1,0,'',0,0,36,1532524664,1532790445,'丰田',5,2,3,'高：约720mm\n宽：约1,400mm\n深：约860mm',4,1800,37.2,'长：4,450mm\n宽：1,760mm\n高：1,470mm','<p><br/></p><p><br/></p><section><table width=\"439\"><tbody><tr class=\"firstRow\"><td valign=\"middle\" rowspan=\"1\" colspan=\"2\" style=\"border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" align=\"center\"><br/></td><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"90\" align=\"center\">24小时以内</td><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"90\" align=\"center\">48小时以内</td><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"81\" align=\"center\">72小时以内</td></tr><tr><td valign=\"middle\" rowspan=\"3\" colspan=\"1\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"88\" align=\"center\"><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51); font-family: 游ゴシック体, \">HC级别<br/>PRIUS</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51); font-family: 游ゴシック体, \"><img alt=\"HC级别\" src=\"/uploads/ueditor/image/20180728/1532785996742255.png\"/></p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51); font-family: 游ゴシック体, \">5人车</p></td><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"89\" align=\"center\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">基本费用</span></td><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"90\" align=\"center\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">NZ$170～</span></td><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"90\" align=\"center\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">NZ$340～</span></td><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"88\" align=\"center\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">NZ$510～</span></td></tr><tr><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"89\" align=\"center\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①风险补偿</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②0风险补偿</span></td><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"90\" align=\"center\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①NZ$30</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②NZ$39</span></td><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"90\" align=\"center\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①NZ$60</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②NZ$78</span></td><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"88\" align=\"center\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①NZ$90</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②NZ$117</span></td></tr><tr><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"89\" align=\"center\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">合计</span></td><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"90\" align=\"center\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①NZ$200～</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②NZ$209～</span></td><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"90\" align=\"center\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①NZ$400～</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②NZ$418～</span></td><td valign=\"middle\" style=\"word-break: break-all; border-width: 1px; border-style: solid; border-color: rgb(221, 221, 221);\" class=\"selectTdClass\" width=\"undefined\" align=\"center\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①NZ$600～</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②NZ$627～</span></td></tr></tbody></table><br/></section><p><br/></p>','','基督城营业所\n皇后镇营业所','HC级'),(2,17,1,'admin','TURBO 4WD','color:;font-weight:normal;','/uploads/20180728/433989d12355388e21ee91106cce8b79.png','','在新西兰自驾游，一定不要错过这台4驱配置，且轻易上手的SUV！而且车内配置的\\\\\\\"Toyota Safety Sense P\\\\\\\"安全系统，轻松辨别车及行人，规避事故发生，减轻交通意外带来的损失。','<p><span>在新西兰自驾游，一定不要错过这台4驱配置，且轻易上手的SUV！而且车内配置的\"Toyota Safety Sense P\"安全系统，轻松辨别车及行人，规避事故发生，减轻交通意外带来的损失。</span></p>','',0,1,0,'',0,1,11,1532786232,1532786904,'丰田',5,2,3,'长：约625mm\n宽：约1,000mm\n深：约770mm\n容量：318L',3,1200,15.4,'长：4,350mm\n宽 ：1,795mm\n高：1,555mm','<p></p><table><tbody><tr class=\"firstRow\"><td valign=\"top\" rowspan=\"1\" colspan=\"2\" style=\"word-break: break-all;\"><br/></td><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\">24小时以内</td><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\">48小时以内</td><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\">72小时以内</td></tr><tr><td width=\"255\" valign=\"top\" rowspan=\"3\" colspan=\"1\" style=\"word-break: break-all;\"><p style=\"box-sizing: border-box; padding-bottom: 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51);\">HC级别<br/>PRIUS</p><p style=\"box-sizing: border-box; padding-bottom: 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51);\"><img alt=\"HC级别\" src=\"/uploads/ueditor/image/20180728/1532785996742255.png\"/></p><p style=\"box-sizing: border-box; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51);\">5人车</p></td><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">基本费用</span></td><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">NZ$170～</span></td><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">NZ$340～</span></td><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">NZ$510～</span></td></tr><tr><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①风险补偿</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②0风险补偿</span></td><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①NZ$30</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②NZ$39</span></td><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①NZ$60</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②NZ$78</span></td><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①NZ$90</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②NZ$117</span></td></tr><tr><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">合计</span></td><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①NZ$200～</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②NZ$209～</span></td><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①NZ$400～</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②NZ$418～</span></td><td width=\"255\" valign=\"top\" style=\"word-break: break-all;\"><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">①NZ$600～</span><br/><span style=\"color: rgb(51, 51, 51); font-family: 游ゴシック体, \">②NZ$627～</span></td></tr></tbody></table><section><br/></section><p><br/></p>','','皇后镇营业所\n基督城营业所','C-HR级'),(3,17,1,'admin','VOXY 4WD','color:;font-weight:normal;','/uploads/20180728/8fbcafee0fe48b8f9234c0be79c51c8a.png','','这是一款8人座车，对家族游或朋友出游再适合不过了！后座折叠后可以容纳5人乘坐，后备箱空间更宽敞！','<p><span>这是一款8人座车，对家族游或朋友出游再适合不过了！后座折叠后可以容纳5人乘坐，后备箱空间更宽敞！</span></p>','',0,1,0,'',0,2,0,1532786558,1532786922,'丰田',8,2,2,'高：约990mm\n宽：约1,350mm\n深：约1,770mm',6,2000,15.0,'长：4,695mm\n款：1,695mm\n高：1,825mm','<p>123213</p>','','皇后镇营业所\n基督城营业所','WB级'),(4,17,1,'admin','HIACE GRAND CABIN 4WD','color:;font-weight:normal;','/uploads/20180728/fbeaa322b709266e23866ac118f6af96.png','','最多可以容纳10人乘坐，是一辆非常适合大家族及团队出游的车辆。全车座椅配备3点式安全带及附带自动调节功能。而且车内附带个人专属后补空调，让每个乘客都可以享受舒适的车内环境。','<p><span>最多可以容纳10人乘坐，是一辆非常适合大家族及团队出游的车辆。全车座椅配备3点式安全带及附带自动调节功能。而且车内附带个人专属后补空调，让每个乘客都可以享受舒适的车内环境。</span></p>','',0,1,0,'',0,3,1,1532786698,1532786934,'丰田',10,5,4,'高：约1,565mm\n宽：约1,695mm\n深：约900mm',10,2700,8.9,'长：5,380mm\n宽：1,880mm\n高：2,280mm','<p>asdfdsafasf</p>','','皇后镇营业所','WD级');
/*!40000 ALTER TABLE `clt_car` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `clt_category` VALUES (1,'攻略','strategy','',0,2,'article','0','1,42,43,44',0,'攻略','攻略','攻略',4,0,1,0,'',1,'','article_list','article_show',0,'1,2,3',0,0,0),(2,'关于我们','about','',0,1,'page','0','2',0,'关于我们','CLTPHP内容管理系统，微信公众平台、APP移动应用设计、HTML5网站API定制开发。大型企业网站、个人博客论坛、手机网站定制开发。更高效、更快捷的进行定制开发。','CLTPHP内容管理系统，微信公众平台、APP移动应用设计、HTML5网站API定制开发。大型企业网站、个人博客论坛、手机网站定制开发。更高效、更快捷的进行定制开发。',0,0,0,0,'',0,'','','',0,'',0,0,0),(39,'驾照说明','driving','cars/',18,1,'page','0,18','39',0,'a','a','a',2,0,1,0,'',0,'','','page_show',0,'',0,0,1),(41,'保险介绍','insurance','cars/',18,1,'page','0,18','41',0,'a','a','a',5,0,1,0,'',0,'','','page_show',0,'',0,0,0),(18,'租车','cars','',0,2,'article','0','18,17,38,39,40,41',0,'','','',0,0,1,0,'',1,'','article_list','article_show',0,'2,3',0,0,0),(8,'联系我们','contact','',0,1,'page','0','8',0,'联系我们','联系我们','联系我们',7,0,0,0,'',0,'','page_show_contace','page_show_contace',0,'',0,0,0),(44,'路线规划','path','strategy/',1,2,'article','0,1','44',0,'路线规划','路线规划','路线规划',2,0,1,0,'',0,'','article_list','article_show',0,'',0,0,0),(43,'购票方式','ticket','strategy/',1,2,'article','0,1','43',0,'购票方式','购票方式','购票方式',1,0,1,0,'',0,'','article_list','article_show',0,'',0,0,0),(40,'交通规则说明','traffic_rule','cars/',18,1,'page','0,18','40',0,'a','a','a',3,0,1,0,'',0,'','','page_show',0,'',0,0,0),(17,'车款介绍','cars','cars/',18,19,'car','0,18','17',0,'','','',0,0,1,0,'/uploads/20180730/da4d638e97b58639cb85b50e023d730a.jpg',0,'','car_list','car_show',10,'1,2,3',0,0,1),(42,'景点介绍','scenic','strategy/',1,2,'article','0,1','42',0,'景点介绍','景点介绍','景点介绍',0,0,1,0,'/uploads/20180731/ecdd90431e1f1ae22688442ac640d1f5.jpg',0,'','article_list','article_show',0,'',0,0,0),(38,'接送说明','pickup','cars/',18,1,'page','0,18','38',0,'a','a','a',4,0,1,0,'/uploads/20180730/85c3cfd6e5566376db22587eb8348339.jpg',0,'','','page_show',0,'',0,0,0);
...
INSERT INTO `clt_debris` VALUES (15,1,'在新西兰OTS也一如既往地致力于提供「安全·安心·舒适的租车服务」','<p style=\"text-align: left;\"><span>在新西兰OTS也一如既往地致力于提供</span><strong>「安全·安心·舒适的租车服务」</strong></p>',1503293255,1),(16,1,'即使在新西兰 我们也将努力让我们的顾客能最大限度的享受旅游的乐趣','<p><span>即使在新西兰</span></p><p><span>我们也将努力让我们的顾客能最大限度的享受旅游的乐趣</span></p>',1503293273,2),(17,1,'简单、高效、低门槛','<p><span style=\"text-align: center;\">CLTPHP内容管理系统，全程鼠标操作，不用手动建立数据库，不用画网站结构图，也不用打开编译器。网站后台直接</span><span style=\"text-align: center;\">编辑</span><span style=\"text-align: center;\">模版，让网站建设达到前所未有的极致简单。</span></p>',1503293291,3),(21,1,'我们在世界各地都很受信任','<p><span>我们在世界各地都很受信任</span></p>',1532427471,50);
...
INSERT INTO `clt_debris_type` VALUES (1,'【首页】文字碎片',1);
...
INSERT INTO `clt_feast` VALUES (2,'圣诞节',1,50,'1513304012','07-18',1),(3,'中秋节',1,2,'1513317857','08-15',2);
...
INSERT INTO `clt_module` VALUES (1,'单页模型','page','单页面',1,0,'*',0,1),(2,'文章模型','article','新闻文章',1,0,'*',0,1),(3,'图片模型','picture','图片展示',1,0,'*',0,1),(4,'产品模型','product','产品展示',1,0,'*',0,1),(5,'下载模型','download','文件下载',1,0,'*',0,1),(6,'团队模型','team','员工展示',1,0,'*',0,1),(19,'汽车模型','car','汽车数据',1,0,'*',0,1);
...
INSERT INTO `clt_page` VALUES (2,'关于我们','color:rgb(95, 184, 120);font-weight:bold;','/uploads/20180611/b78388d0d1b123e06d900c4d1a1d88ba.jpg',28,'1',0,'',0,1504251653,0,0,'<p style=\"box-sizing: border-box; border: 0px; font-stretch: inherit; font-size: 14px; line-height: 24px; font-family: \"><a href=\"http://www.cltphp.com/\" target=\"_blank\" title=\"CLTPHP内容管理系统\" style=\"color: rgb(146, 208, 80); text-decoration: none;\"><span style=\"color: rgb(146, 208, 80);\">CLTPHP内容管理系统</span></a>，包含系统设置，权限管理，模型管理，数据库管理，栏目管理，会员管理，网站功能，模版管理，微信管理等相关模块。基于ThinkPHP5开发，后台采用Layui框架完全自适应，数据交互采用更高效简洁的angularjs实现，。</p><p style=\"box-sizing: border-box; border: 0px; font-stretch: inherit; font-size: 14px; line-height: 24px; font-family: &#39;Microsoft yahei&#39;, Arial, Tahoma, Verdana; vertical-align: baseline; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 20px; color: rgb(151, 151, 151); white-space: normal; background-color: rgb(255, 255, 255);\">　　<a target=\"_blank\" href=\"http://www.cltphp.com/\" style=\"box-sizing: border-box; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; vertical-align: baseline; margin: 0px; padding: 0px; outline: 0px; color: rgb(146, 208, 80); text-decoration: none;\"><span style=\"color: rgb(146, 208, 80);\">CLTPHP</span></a>采用ThinkPHP开发，ThinkPHP5采用全新的架构思想，引入了很多的PHP新特性，优化了核心，减少了依赖，实现了真正的惰性加载。正因为ThinkPHP的这些新特性，从而使得CLTPHP的执行速度成倍提高。</p><p style=\"box-sizing: border-box; border: 0px; font-stretch: inherit; font-size: 14px; line-height: 24px;\">　　UI方面，<a target=\"_blank\" href=\"http://www.cltphp.com/\" style=\"box-sizing: border-box; border: 0px; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; vertical-align: baseline; margin: 0px; padding: 0px; outline: 0px; color: rgb(146, 208, 80); text-decoration: none;\"><span style=\"color: rgb(146, 208, 80);\">CLTPHP</span></a>采用了最受欢迎的Layui，Layui用于开发响应式布局、移动设备优先的 WEB 项目。简洁、直观、强悍的前端开发框架，让CLTPHP的后台界面更加美观，开发更迅速、简单。</p>','0'),(8,'联系我们','color:;font-weight:normal;','',10,'1',0,'',0,1499765407,0,0,'<p>您的支持是我们一往无前的无限动力，非常荣幸在<a target=\"_self\" href=\"http://www.cltphp.com/\">CLTPHP</a>成长的道路上有您的陪伴！！！</p>',''),(38,'从预约到出发','color:;font-weight:normal;','/uploads/20180730/83e9da52a7722a057822e04342f89898.jpg',0,'1',0,'',0,1532918996,0,0,'<section><h1 style=\"box-sizing: border-box; margin: 0px 0px 60px; padding: 10px 20px; background: rgb(91, 161, 230); border: 0px; outline: 0px; font-size: 26px; color: rgb(255, 255, 255);\">1.预约</h1><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">请提供以下信息，以便为您预约。根据您提供的租车日期确认是否有车，再回复您。<br/>还可为您报价。欢迎随时与我们联系。</p><ol class=\"mt20 ml20 mb20 list-paddingleft-2\" style=\"list-style-type: none;\"><li><p>租车日期（出发日期、还车日期）</p></li><li><p>希望的车种（级别）</p></li><li><p>乘车人数</p></li><li><p>司机人数</p></li><li><p>最年轻司机的年龄</p></li><li><p>租车台数</p></li><li><p>代表者姓名</p></li><li><p>联络电话</p></li><li><p>邮箱地址</p></li><li><p>是否有需要加购项目</p></li><li><p>是否需要接送</p></li><li><p>到达・或回程航班号、或者其他交通方式</p></li><li><p>是否使用优惠券</p></li></ol></section><p></p><section><h1 style=\"box-sizing: border-box; margin: 0px 0px 60px; padding: 10px 20px; background: rgb(91, 161, 230); border: 0px; outline: 0px; font-size: 26px; color: rgb(255, 255, 255);\">2. 机场接送・來店</h1><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">机场接驳服务</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">提供皇后镇机场和基督城机场的机场接驳服务。（收费）<br/><a class=\"link\" href=\"https://www.otsinternational.nz/otsrentacar/zh/pickup/airport/\" style=\"box-sizing: border-box; margin: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; text-decoration-line: none; color: rgb(0, 92, 255); transition: 0.4s;\">机场接送</a></p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">关于直接来店</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">自行来店的情况，请事先在营业所介绍页面确认地址后前来。<br/><a class=\"link\" href=\"https://www.otsinternational.nz/otsrentacar/zh/office/queenstown/\" style=\"box-sizing: border-box; margin: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; text-decoration-line: none; color: rgb(0, 92, 255); transition: 0.4s;\">确认皇后镇营业所地址</a><br/><a class=\"link\" href=\"https://www.otsinternational.nz/otsrentacar/zh/office/christchurch/\" style=\"box-sizing: border-box; margin: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; text-decoration-line: none; color: rgb(0, 92, 255); transition: 0.4s;\">确认基督城营业所地址</a></p></section><section><h1 style=\"box-sizing: border-box; margin: 0px 0px 60px; padding: 10px 20px; background: rgb(91, 161, 230); border: 0px; outline: 0px; font-size: 26px; color: rgb(255, 255, 255);\">3. 租车手续・付款</h1><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">请在营业所办理租车手续并提前准备好以下资料以便确认。</p><ol class=\"ml20 mb20 list-paddingleft-2\" style=\"list-style-type: none;\"><li><p>预约号码</p></li><li><p>驾驶者证件<a class=\"link\" href=\"https://www.otsinternational.nz/otsrentacar/zh/rule/license/\" style=\"box-sizing: border-box; margin: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; text-decoration-line: none; color: rgb(0, 92, 255); transition: 0.4s;\">（在新西兰开车所需的驾照）</a></p></li><li><p>新西兰国籍以外的客人请出示护照</p></li><li><p>信用卡</p></li><li><p>优惠券</p></li></ol><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">■租车手续完成后，请付款。（取车前付款)<br/>■虽然能够在现场以现金方式付款，但还是必须出示您的信用卡。<br/><span style=\"box-sizing: border-box; margin: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: red;\">※本公司只能够使用VISA/Master/UnionPay的信用卡</span></p></section><section><h1 style=\"box-sizing: border-box; margin: 0px 0px 60px; padding: 10px 20px; background: rgb(91, 161, 230); border: 0px; outline: 0px; font-size: 26px; color: rgb(255, 255, 255);\">4. 取车</h1><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">我们将向您简单介绍车辆，并与您一同检查车身外观是否有刮痕。<br/>确认完后，您可以立刻开车并离开。<br/>由于车辆已加满油，所以无需再次加油。</p></section><section><h1 style=\"box-sizing: border-box; margin: 0px 0px 60px; padding: 10px 20px; background: rgb(91, 161, 230); border: 0px; outline: 0px; font-size: 26px; color: rgb(255, 255, 255);\">5. 还车/超时・其他</h1><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">请在规定时间内还车，如果超出预定还车时间，请提前联系我们。<br/>还车后，相关工作人员将记录您实际里程数，并检查车辆外观及车内设备。<br/>还车前，请务必加满油。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">※如果超过还车时间，我们将向您收取超时费用。<br/>如果未能加满油还车，将按照您实际行走距离收取油费。</p></section><section><h1 style=\"box-sizing: border-box; margin: 0px 0px 60px; padding: 10px 20px; background: rgb(91, 161, 230); border: 0px; outline: 0px; font-size: 26px; color: rgb(255, 255, 255);\">6. 关于还车后机场接送</h1><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">在还车后我们也提供前往皇后镇以及基督城机场的接驳服务</p></section><p></p><p><br/></p>','page_show'),(39,'关于驾驶证件','color:;font-weight:normal;','',0,'1',0,'',0,1532919459,0,0,'<h1 style=\"box-sizing: border-box; margin: 0px 0px 60px; padding: 10px 20px; background: rgb(91, 161, 230); border: 0px; outline: 0px; font-size: 26px; color: rgb(255, 255, 255); font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; white-space: normal;\">必备的驾驶证件</h1><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51); font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; font-size: 18px; white-space: normal;\">在新西兰开车，不管是新西兰本国人，或是海外游客，有随身携带驾驶证开车的义务。 海外游客租车时，需出示护照。另外，旅途中也请随身携带护照。<br/>在新西兰，法律上只需要携带自己国家的有效驾驶证件即可驾驶12个月。<br/><span style=\"box-sizing: border-box; margin: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: red;\">但是，如果所持驾照并非英文驾照，需与自己国家的有效驾照一起携带依据国际条约发行的国际驾照或本国驾照的正式英文译本。</span></p><ul class=\"mb25 ml20 list-paddingleft-2\" style=\"box-sizing: border-box; margin-top: 0px; margin-right: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; color: rgb(51, 51, 51); font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; font-size: 18px; white-space: normal; margin-bottom: 25px !important; margin-left: 20px !important;\"><li style=\"\"><p>非新西兰国籍的顾客，需出示护照。</p></li><li style=\"\"><p>・新西兰驾照</p></li><li style=\"\"><p>・全英文记载的本国驾照</p></li><li style=\"\"><p>・非英文记载的本国驾照 + 依据国际条约发行的国际驾照或正式英文译本</p></li></ul><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51); font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; font-size: 18px; white-space: normal;\">入国起超过12个月的情况，即使本国驾照或国际驾照仍在有效期以内也必须另外提供新西兰的本土驾照才可上路。※12个月由入国当天开始计算。<br/>另外，所驾驶的车辆，仅限与本国驾照许可的车辆条件相符的车子。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51); font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; font-size: 18px; white-space: normal;\">※开车时即便持有有效驾照，但却未携带依据国际条约发行的国际驾照或译本而被警察逮捕时，将有可能会被以无证驾驶或未携带相符的驾照驾驶等理由起诉。若被判有罪，需缴纳一定的罚款。另外，若在上诉条件的情况下引发交通事故，保险将不给于赔偿。</p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223); font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; white-space: normal;\">根据国际条约发行的国际驾照（IDP)</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51); font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; font-size: 18px; white-space: normal;\">所谓依据《日内瓦条约》发行的国际驾照，是指依据国际条约而发行的驾照，作为本国驾照翻译文件使用，以及需要随身携带本国驾照，即可在新西兰国内驾驶。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51); font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; font-size: 18px; white-space: normal;\">如果自己国家也同为《日内瓦条约》等国际条约的加盟国，请在出发前在自己国家事先申请国际驾照。详情请咨询驾照发行中心。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51); font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; font-size: 18px; white-space: normal;\">国际驾照的有效期限为1年。如果已经有国际驾照，请确认有效期限。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51); font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; font-size: 18px; white-space: normal;\">如不清楚本国发行驾照是否有加入国际条约或是否有效，您可以在预约前向OTS租车公司确认。</p><h3 class=\"wd-ttl\" style=\"box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 2rem; color: red; font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; white-space: normal;\">持有依据日内瓦条约颁发的国际驾照者，请确认是否可以驾驶WD级（限10座）的车子。</h3><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">持有国际驾照的驾驶员，由于驾照级别不同，可驾驶车辆的种类也不同。<br/>B:普通车辆（8人座上限）<br/>D:大型汽车（10人座以上）WD级别</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">国际驾照翻至带驾驶员照片一页，左栏A-E为驾驶级别。驾驶10人车（WD级别），D栏必须有盖章。如无盖章，而驾驶WD级别车辆的情况，将视为无证驾驶。</p><p><img class=\"fr\" src=\"https://www.otsinternational.nz/otsrentacar/zh/img/page/rule/d-stamp.png\" alt=\"d-stamp\"/></p><h3 class=\"wd-ttl\" style=\"box-sizing: border-box; margin: 40px 0px 10px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 2rem; color: red; font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; white-space: normal;\">民间团体・企业等发行的国际驾驶执照如下<br/>(IDL / IAA / KIDA / IDD / IADA / ITDL / TIDL 等)</h3><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51); font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; font-size: 18px; white-space: normal;\">在OTS租车公司租车时，持国际条约以外发行的「国际驾照」，将不予租车。请您事先准备好符合国际条约的「国际驾照(IDP) 」以及本国驾照。<br/>※如不清楚本国发行驾照是否有符合国际条约或是否有效，您可以在预约前向OTS租车公司确认。</p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223); font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; white-space: normal;\">正式的英文译本</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; color: rgb(51, 51, 51); font-family: 游ゴシック体, &quot;Yu Gothic&quot;, YuGothic, &quot;ヒラギノ角ゴ Pro W3&quot;, &quot;Hiragino Kaku Gothic Pro&quot;, sans-serif; font-size: 18px; white-space: normal;\">本国的有效驾照非英文记载的情况，需与自己国家的驾照一起出示该驾照的英文译本。&nbsp;<br/>仅限以下机构所发行的正式英文译本。</p><ul class=\"mb25 ml20 list-paddingleft-2\" style=\"list-style-type: none;\"><li><p>・<a class=\"link\" href=\"https://www.nzta.govt.nz/driver-licences/new-residents-and-visitors/approved-translators/\" style=\"box-sizing: border-box; margin: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; text-decoration-line: none; color: rgb(0, 92, 255); transition: 0.4s;\">新西兰交通局（NZ Transport Agency) 认可的翻译中心</a></p></li><li><p>・外交机关（高等专员的外交代表处/大使馆/领事馆）</p></li><li><p>・中国公证处</p></li></ul><p><br/></p>','page_show'),(40,'关于新西兰的道路状况及交通规则','color:;font-weight:normal;','',0,'1',0,'',0,1532919595,0,0,'<section><h1 style=\"box-sizing: border-box; margin: 0px 0px 60px; padding: 10px 20px; background: rgb(91, 161, 230); border: 0px; outline: 0px; font-size: 26px; color: rgb(255, 255, 255);\">交通・道路状况</h1><h2 class=\"mt0\" style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">左侧通行</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">新西兰主要为右舵。不习惯靠左车道行驶的朋友一定要注意安驾驶，特别是要左转或右转时，不要逆行。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/ph_keep_left.png\" alt=\"\"/></p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">高速公路及国道</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">在新西兰，汽车专用的高速道路称为Mortorway，国道称为Highway。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">城市道路的最高限速为50km/h，郊区为0km/h~100km/h。第一次在新西兰开车的朋友也许会对周围车辆的车速感到吃<br/>惊，但是请不要迎合他人，故意快速行驶。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">急转弯前立有限速标志，黄色的背景黑白的数字为最高限速标志。请控制在此速度以内，安全拐弯。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">高速公路的最高法定速度为100km/h，超速将被收取一定的罚款。紧急情况意外，请勿随意停车。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/ph_way01.jpg\" alt=\"\" class=\"mb5\"/><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/ph_way02.jpg\" alt=\"\" class=\"mb5\"/></p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">关于限速</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">限速标志的有效范围为从此标志到下一个限速标志出现为止。比如，假设此路段的限速标志为100km/h, 那么它将适用于下一个限速标志出现为止。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">路上有安全监控摄像头。请切勿超速！</p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">关于鸣笛</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">在新西兰，人们很少随意鸣笛。城市道路，夜晚及清晨禁止鸣笛。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">在万不得已的情况下才可以鸣笛。</p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">道路状况</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">新西兰的道路基本分为3种。<br/>请根据实际路况开车。根据路面状况的差异也会诶开车带来一定的影响。請十分注意路面状况的变化！</p><h3 style=\"box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 24px; color: rgb(91, 161, 230);\">柏油路面</h3><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">一般的柏油路外观为褐色，表面平缓。开车经过与地面接触时非常安静。<br/>常见于车流量大的道路及转弯处易于刹车的路面。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">虽然这种路面容易刹车，但是下雨时，轮胎不容易抓地。<br/>因此，当路面呈湿漉漉状时，请注意安全驾驶！</p><h3 style=\"box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 24px; color: rgb(91, 161, 230);\">焦油混碎石路面</h3><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">这是一种焦油混大量细碎沙石的路面。<br/>路面状况良好的情况下，可看到表现凹凸不平。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">但是由于长年累月被大量汽车碾过，表面的凹凸并不明显。<br/>通常在这种路面行驶时，轮胎的抓力比较弱，容易打滑。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">如果在这种类型的路面开车，请小心驾驶。</p><h3 style=\"box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 24px; color: rgb(91, 161, 230);\">砂石路面</h3><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">沙石路面一般出现于车辆通行量较少的道路。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">地方主干道以外的道路基本上为砂石路面。<br/>在砂石路面行驶时，由于轮胎处于滑动状态，非常容易打滑<br/>经过时也容易被对向车夹杂在轮胎缝隙里的小石头从轮胎飞出砸到，请一定要减速慢行！</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">请务必根据道路状况安全驾驶！<br/>另外，天气好时，由于对向车开过容易卷起灰尘，影响前方视线，请注意车间距离。</p></section><p><section><h1 style=\"box-sizing: border-box; margin: 0px 0px 60px; padding: 10px 20px; background: rgb(91, 161, 230); border: 0px; outline: 0px; font-size: 26px; color: rgb(255, 255, 255);\">关于交通规则</h1><h2 class=\"mt0\" style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">左侧通行</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">车辆靠左行驶。</p><h2 class=\"mt0\" style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">左转优先</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">左转车辆有优先权。</p><h2 class=\"mt0\" style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">圆环</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">在新西兰，大部分交叉口用圆环代替了信号灯。<br/>通过圆环时，所有车辆从左边进入，顺时针方式行驶。</p><h3 style=\"box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 24px; color: rgb(91, 161, 230);\">关于圆环路优先原则</h3><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">进入圆环入口时，右侧车辆具有优先权。</p><h4 style=\"box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 20px; color: rgb(91, 161, 230);\"><span class=\"label-num\" style=\"box-sizing: border-box; margin: 0px 5px 0px 0px; padding: 3px 8px; background: rgb(91, 161, 230); border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; display: inline-block; border-radius: 3px; color: rgb(255, 255, 255); line-height: 1;\">1</span>单行道圆环</h4><h5 style=\"box-sizing: border-box; margin: 0px 0px 5px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 18px; color: rgb(91, 161, 230);\">圆环内为单车道时</h5><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">进入圆环时请减速慢行。<br/>进入圆环时先确认右方横穿车辆，它们有行驶优先权，请注意。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/ph_road01.png\" alt=\"\"/></p><h5 style=\"box-sizing: border-box; margin: 0px 0px 5px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 18px; color: rgb(91, 161, 230);\">多车道圆环</h5><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">圆环内车道为两车道以上的情况，为了方便进入离开圆环，请按照路面上的标记选择自己行驶的车道。</p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">但是，不是所有的圆环路面都有标志。<br/>请仔细选择行驶的车道。<br/>在出圆环时需要特别注意。<br/>如果在出去时需要变换车道，请特别注意先让有优先权的车辆通过。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/ph_road02.png\" alt=\"\"/></p><h5 style=\"box-sizing: border-box; margin: 0px 0px 5px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 18px; color: rgb(91, 161, 230);\">进入一些多车道圆环时</h5><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">进入正确的车道。<br/>进入圆环时，进入圆环先确认右方横穿车辆，它们有行驶优先权。</p><h4 style=\"box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 20px; color: rgb(91, 161, 230);\"><span class=\"label-num\" style=\"box-sizing: border-box; margin: 0px 5px 0px 0px; padding: 3px 8px; background: rgb(91, 161, 230); border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; display: inline-block; border-radius: 3px; color: rgb(255, 255, 255); line-height: 1;\">2</span>圆环方向灯的使用方法</h4><h5 style=\"box-sizing: border-box; margin: 0px 0px 5px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 18px; color: rgb(91, 161, 230);\">进入圆环左转时</h5><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">接近圆环时，打向左的方向灯。</p><p class=\"bottom tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center; position: absolute; bottom: 0px;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/ph_road06.png\" alt=\"\"/></p><h5 style=\"box-sizing: border-box; margin: 0px 0px 5px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 18px; color: rgb(91, 161, 230);\">进入圆环直行时</h5><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">接近圆环时不打方向灯。快到出口时打左转方向灯。<br/>有时在小型圆环不容易打方向灯。<br/>请尽量传达要出去的意思。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/ph_road07.png\" alt=\"\"/></p><h5 style=\"box-sizing: border-box; margin: 0px 0px 5px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 18px; color: rgb(91, 161, 230);\">圆环行驶过半以上的情况</h5><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">进入圆环后打右转方向灯。<br/>当您在位于需要出去的出口和前一个出口中间的位置时请打左转方向灯。</p><ul class=\"box_attention bottom list-paddingleft-2\" style=\"box-sizing: border-box; margin: 40px 0px 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 2px solid rgb(164, 0, 0); outline: 0px; position: absolute; bottom: 0px;\"><li><p>请注意</p></li><li><p>禁止在圆环里绕圈。</p></li></ul><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/ph_road08-zh.png\" alt=\"\"/></p><h4 style=\"box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 20px; color: rgb(91, 161, 230);\"><span class=\"label-num\" style=\"box-sizing: border-box; margin: 0px 5px 0px 0px; padding: 3px 8px; background: rgb(91, 161, 230); border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; display: inline-block; border-radius: 3px; color: rgb(255, 255, 255); line-height: 1;\">3</span>圆环的标志</h4><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/img_sign01.png\" alt=\"\"/></p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">表示前方有圆环。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/img_sign02.png\" alt=\"\"/></p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">保持靠左行驶。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/img_sign03.png\" alt=\"\"/></p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">按照圆环让路规则行驶。</p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">让路</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">【Give Way】的标志通常出现于优先道路的交汇处。<br/>虽然交汇车辆具有优先权，但是不需要停车确认道路状况。<br/>只需确保安全的情况下交汇即可。</p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">关于高架桥的单车道优先权。</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">在新西兰，普遍为双车道。单国道常有单车道通行的高架桥。过桥时请相互谦让。<br/>所有的单车道高架桥入口处一定有标识优先原则的规则。<br/>单车道与对向车交会时，礼让对向车。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/ph_bridge.jpg\" alt=\"\"/></p><h5 class=\"ml2\" style=\"box-sizing: border-box; margin: 0px 0px 5px 20.5938px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 18px; color: rgb(91, 161, 230);\">高架桥上的车辆优先行驶标志</h5><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/img_sign04.png\" alt=\"\"/><span class=\"bridge-ex\" style=\"box-sizing: border-box; margin: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; display: block; text-align: left;\">这两个标志表示您必须为对面驶来的过桥车辆让行。</span></p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/img_sign04-2.png\" alt=\"\"/><span class=\"bridge-ex\" style=\"box-sizing: border-box; margin: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; display: block; text-align: left;\">这个标志表示如果没有车辆驶来，您可以小心地过桥。</span></p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">关于乘坐儿童安全座椅的义务及保护儿童安全的措施。</h2><h3 style=\"box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 24px; color: rgb(91, 161, 230);\">装载义务</h3><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">驾驶员，全体乘客必须系安全带。儿童务必使用儿童安全座椅。<br/>15岁以上所有的乘客都必须系安全带。全车均使用3点式安全带。<br/>*新西兰的车辆与日本的不一样，后座也全部使用3点式安全带。</p><h3 style=\"box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 24px; color: rgb(91, 161, 230);\">确保儿童安全的义务</h3><h4 style=\"box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 20px; color: rgb(91, 161, 230);\">4岁以下</h4><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">4岁以下的儿童有义务使用标准的儿童安全座椅。</p><h4 style=\"box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; font-size: 20px; color: rgb(91, 161, 230);\">5岁以上，7岁以下</h4><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">如果车内有儿童安全座椅，5岁以上，7岁以下的儿童必须乘坐。如果没有，请务必系好安全带。</p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">在郊外行驶时请注意有人骑马经过的情况。</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">前方道路有看到马的时候请注意谨慎驾驶。<br/>车辆经过可能会引起马匹的惊慌，请减速慢行。</p><ul class=\"box_attention list-paddingleft-2\" style=\"box-sizing: border-box; margin: 40px 0px 0px; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 2px solid rgb(164, 0, 0); outline: 0px;\"><li><p>注意</p></li><li><p>在田间、林间道路中驾驶时会有小动物或者鸟类飞出，请及时避让。<br/>在高速行驶过程中急打方向盘很危险。<br/>急刹车容易导致车身打滑，与后方车辆碰撞。<br/>遇到突发事件保持冷静。</p></li></ul></section><section><h1 style=\"box-sizing: border-box; margin: 0px 0px 60px; padding: 10px 20px; background: rgb(91, 161, 230); border: 0px; outline: 0px; font-size: 26px; color: rgb(255, 255, 255);\">路标</h1><h2 class=\"mt0\" style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">交通指示牌</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">一般用蓝色或红色表示。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/img_sign06-zh.png\" alt=\"\"/></p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">依照标志不同有些标志会以红色来取代边框。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/img_sign07-zh.png\" alt=\"\"/></p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">警告标志</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">通常警告标志以黄色和黑色表示。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/img_sign08-zh.png\" alt=\"\"/></p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">临时设置标志</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">临时设置标志通常以橘黄色和黑色表示。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/img_sign09-zh.png\" alt=\"\"/></p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">信息标志</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">形状为长方形，大小和颜色会有差异。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/img_sign10-zh.png\" alt=\"\"/></p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">限速标志</h2><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px 0px 1.5em; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word;\">限速是指在天气、道路状况良好的情況下可以行驶的最高速度。</p><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/img_sign11-zh.png\" alt=\"\"/></p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">相关限速标志</h2><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/img_sign12-zh.png\" alt=\"\"/></p><h2 style=\"box-sizing: border-box; margin: 60px 0px 20px; padding: 0px 15px; background: rgba(91, 161, 230, 0.2); border-width: 0px 0px 0px 6px; border-top-style: initial; border-right-style: initial; border-bottom-style: initial; border-left-style: solid; border-top-color: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: rgb(91, 161, 230); border-image: initial; outline: 0px; font-size: 24px; color: rgb(63, 147, 223);\">停车相关标志</h2><p class=\"tac\" style=\"box-sizing: border-box; margin: 0px auto; padding: 0px; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; border: 0px; outline: 0px; overflow-wrap: break-word; word-wrap: break-word; text-align: center;\"><img src=\"https://www.otsinternational.nz/otsrentacar/zh/img/nz/trafic/img_sign13-pc-zh.png\" alt=\"\" class=\"sp-img\"/></p></section></p><p><br/></p>','page_show'),(41,'','','',0,'1',0,'',0,0,0,0,NULL,'');
...
--
-- Dumping data for table `clt_product`
--

LOCK TABLES `clt_product` WRITE;
/*!40000 ALTER TABLE `clt_product` DISABLE KEYS */;
/*!40000 ALTER TABLE `clt_product` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `clt_system` VALUES (1,'OTS新西兰自驾游','http://www.otsxxlzjy.com/','OTS新西兰自驾游','OTS新西兰自驾游','OTS新西兰自驾游','浙ICP备15008093号-3','2015-2020','杭州市江干区富春路789号401室-59','15068835066','qiuqian1988@icloud.com','/uploads/20180724/c4b5b4026ec721b898daba632a70ab6f.png','close','close');
...
--
-- Dumping data for table `clt_team`
--

LOCK TABLES `clt_team` WRITE;
/*!40000 ALTER TABLE `clt_team` DISABLE KEYS */;
/*!40000 ALTER TABLE `clt_team` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `clt_users` VALUES (1,'1109305987@qq.com','e10adc3949ba59abbe56e057f20f883e',NULL,1,0,1516075631,0,'','','44311',0,'',NULL,NULL,'/uploads/20180613/fcb729987d8e9339bd9b2e85c85f3028.jpg',24,311,2599,0,'chichu',1,0,'','不要应为走得太远，就忘了当初为什么出发！','hide');
...
INSERT INTO `clt_wx_menu` VALUES (1,0,'官网','',0,2,3,'http://www.cltphp.com/',0,1,1512442512,0),(2,0,'手册','',0,2,5,'http://www.cltphp.com/',0,2,1512442543,0),(3,0,'论坛','',0,1,4,'http://bbs.cltphp.com/',0,3,1512547727,0);
...
-- Dump completed on 2018-07-31 15:49:58
